package com.tutorusdude.mobilerecharge;
...
import com.tutorusdude.mobilerecharge.service.MobileRechargeService;
...
public class Runner {
    ...
    private static void doRecharge(MobileRechargeService service, Long phoneNumber, PlanDto plan, int balance) {
    ...
    private static void printRechargeHistory(MobileRechargeService service, Long phoneNumber) {
