...
public class Runner {
    public static void main(String[] args) {
        ...
        pogo.cartoonName = "Choota Bheem";
        pogo.isCartoonChannel = true;

        pogo.channel();         // Non-Static
        Pogo.famousCartoon();  // Static
        ...
        Bluetooth.deviceType = "Electronic Device";
        Bluetooth.connectionType = "Wireliss Connection";
        Bluetooth.range = 10;

        Bluetooth bluetooth = new Bluetooth("airpods", 56);
        System.out.println(bluetooth.deviceName + bluetooth.price);

        bluetooth.deviceName = "Bloat";
        bluetooth.price = 1000;

        bluetooth.printBluetooth();

        bluetooth.device();        // Non-static
        Bluetooth.connection();   // static
