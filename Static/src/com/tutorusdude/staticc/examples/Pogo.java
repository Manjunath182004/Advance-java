...
public class Pogo {
    ...
    static {                              // initializing Static Variables Using Static Blocks
        channelName = "Cartoon Network";
        time = "9AM & 5PM Daily";
    }

    public Pogo (String cartoonName, boolean isCartoonChannel) {                      // initializing non-static Variables Using Constructor
